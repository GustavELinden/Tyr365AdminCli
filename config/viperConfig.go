...
func InitViper(configFileName string) (*viper.Viper, error) {
	...
	viperInstance.AddConfigPath("/root/condigurationFolder/") // Root configuration folder
	viperInstance.AddConfigPath("~/condigurationFolder/")     // Home configuration folder (fallback)
